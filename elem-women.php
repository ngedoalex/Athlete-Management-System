              ...
              <table id="" class="" border="1" style="border-collapse: collapse; " width="100%">
                    <thead>   
                      <?php 
                      $query=mysqli_query($con,"SELECT * from tbl_games where event_id='$active_event_id' and level='Elementary' and category='Girls' order by game_name ASC");
                      $num=mysqli_num_rows($query);
                      ?>
                      
                      <tr>
                        <th colspan="<?php echo ($num*3)+4?>">ELEMENTARY ATHLETICS RESULT (GIRLS) <a onclick='window.open("print.php?print=elem-girls","","width=1200,height=600");' class="btn btn-sm pull-right"><i class="fa fa-print"></i></a></th>
                      </tr>
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <?php $q2=mysqli_query($con,"SELECT * from tbl_games where event_id='$active_event_id' and level='Elementary' and category='Girls' order by game_name ASC"); //find all delegates
                          while ($r2=mysqli_fetch_assoc($q2)) {
                          ?>
                         
                          
                          <td  style="font-size:13px;"><!--GOLD-->
                            <?php $gold=mysqli_query($con,"SELECT * from tbl_winner w inner join tbl_athlete a where a.del_id='$r1[del_id]' and w.a_id=a.a_id and standing_id='Gold' and w.game_id='$r2[game_id]' and a.a_category='Girls'");
                          ...
                          <td  style="font-size:13px;">
                            <?php $silver=mysqli_query($con,"SELECT * from tbl_winner w inner join tbl_athlete a where a.del_id='$r1[del_id]' and w.a_id=a.a_id and standing_id='Silver' and w.game_id='$r2[game_id]' and a.a_category='Girls'");
                          ...
                          <td  style="font-size:13px;">
                            <?php $bronze=mysqli_query($con,"SELECT * from tbl_winner w inner join tbl_athlete a where a.del_id='$r1[del_id]' and w.a_id=a.a_id and standing_id='Bronze' and w.game_id='$r2[game_id]' and a.a_category='Girls'");
