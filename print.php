...
<?php include'session.php';?>
  <div style="background: white; width:12.5in; display: block; ">&nbsp;
    <img src="<?=$set['event_logo']?>" style="height:80px; top:13px;margin-top:10px; position: absolute; left:350px; ">
  <font style="text-align: center; position: absolute; left:500px; top:30px;">
      <?=nl2br($set['event_heading'])?><br>
  ...
  $event_description=$res['event_description']; ?>
    <font style="text-align: center; position: absolute; left:400px; top:150px; font-size:20px;">
<B><?php echo strtoupper($event_description);?></B>
  </font>
  <div style="position: absolute; top:190px; width:13in">
