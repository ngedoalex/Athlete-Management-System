...
<tr align="left">
    ...
    <td>Event No.: <font style="border-bottom:1px solid black; padding-left:10px; padding-right:50px;"></font></td>
...
<?php for($i=1; $i<=8; $i++){
  $q=mysqli_query($con,"SELECT * from tbl_top_6 as t6 inner join tbl_athlete as a inner join tbl_delegates as d where d.event_id='$active_event_id' and t6.game_id='$row[game_id]' and t6.rank='$i' and a.a_id=t6.a_id and d.del_id=a.del_id");
