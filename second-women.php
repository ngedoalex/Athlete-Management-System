              ...
              <table id="" class="" border="1" style="border-collapse: collapse; " width="100%">
                    <thead>   
                      <?php 
                      $query=mysqli_query($con,"SELECT * from tbl_games where event_id='$active_event_id' and level='Secondary' and category='Girls' order by game_name ASC");
                      $num=mysqli_num_rows($query);
                      ?>
                      
                      <tr>
                        <th colspan="<?php echo ($num*3)+4?>">SECONDARY ATHLETICS RESULT (GIRLS) <a onclick='window.open("print.php?print=second-girls","","width=1200,height=600");' class="btn btn-sm pull-right"><i class="fa fa-print"></i></a></th>
                      </tr>
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <?php $q2=mysqli_query($con,"SELECT * from tbl_games where event_id='$active_event_id' and level='Secondary' and category='Girls' order by game_name ASC"); //find all delegates
